...
// {
  $sql = "INSERT INTO payments (order_id, tracking_id, bank_ref_no, order_status, payment_mode, card_name, currency, billing_name, billing_email, trans_date,  reason, amount,transaction_status)
VALUES ('$order_id','$tracking_id','$bank_ref_no','$order_status','$payment_mode','$card_name','$currency','$billing_name','$billing_email','$trans_date','$reason','$amount','Successful')";
//   echo "ORDER ID - ". $_SESSION['oId'];
  ...
  <tbody>
    ...
    $sql = "INSERT INTO payments (order_id, tracking_id, bank_ref_no, order_status, payment_mode, card_name, currency, billing_name, billing_email, trans_date,  reason, amount,transaction_status)
    VALUES ('$order_id','$tracking_id','$bank_ref_no','$order_status','$payment_mode','$card_name','$currency','$billing_name','$billing_email','$trans_date','$reason','$amount','Failed')";
	}
